...
|---|---|
| **[Usage](docs/usage.md)** | The full five-step workflow — geometry, meshing, boundary conditions, running, results — plus the complete CLI reference for all 43 flags and worked recipes |
...
| test suite | 248 tests, plus 6 full-fidelity benchmark regressions |
